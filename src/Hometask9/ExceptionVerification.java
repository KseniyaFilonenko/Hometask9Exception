...
public class ExceptionVerification {
    ...
    public class WrongDocumentFormatException extends Exception {
        ...
        public void numberOfDocument(Hometask9.Document[] documents) throws WrongDocumentFormatException {
            for (Hometask9.Document document : documents) {
